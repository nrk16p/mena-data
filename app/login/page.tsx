  ...
  if (status === "loading") {
    return (
      <div className="fixed inset-0 flex items-center justify-center" style={bgStyle}>
        ...
        <div className="relative z-10 text-[10px] tracking-[0.3em] text-white/35 uppercase">
          Loading
        </div>
      </div>
    )
      ...
      >
        <div className="rounded-2xl border border-white/10 bg-white/8 backdrop-blur-md px-6 py-7">
          ...
          <div className="mb-4 text-center">
            <h1 className="text-2xl font-extrabold tracking-[0.2em] bg-clip-text text-transparent bg-linear-to-r from-blue-700 via-blue-500 to-blue-400 uppercase mb-1">
              Mena Data
            </h1>
          ...
          <p className="mt-4 text-center text-[11px] tracking-wide text-white">
            @menatransport.co.th{" "}
            <span className="font-medium text-[12px] text-red-700 ml-1">only</span>
          </p>
        </div>
      </div>
    </div>
